...
def sherlock(
    ...
    '''
    session = Session()
    proxy_host = "proxy_host"  # Proxy host URL or IP
    proxy_port = 8080  # Proxy port
    proxy_user = "username"  # Username for proxy authentication
    proxy_pass = "password"  # Password for proxy authentication
    ...
    super(Session, session).proxies.update(proxies)
    print(super(Session, session).proxies)'''
...
def main():
    ...
    if args.proxy is not None:
        print("Using the proxy: " + args.proxy[-20:])
